...
export const INITIAL_DOCUMENTS = [
  {
    ...
    documentNumber: '9942-8810-7214-0019',
    issueDate: '2023-05-12',
    expirationDate: 'No Expiration (Lifetime)',
    isEgovRetrieved: true,
    fileSize: '1.8 MB',
    fileType: 'PDF/A',
    verifiedBadge: 'Official PSA Signature Verified',
  ...
  },
  {
    ...
    status: 'Valid',
    issuer: 'Philippine Health Insurance Corp.',
    documentNumber: '12-059841209-4',
    issueDate: '2025-01-15',
    expirationDate: '2027-01-15',
    isEgovRetrieved: true,
    fileSize: '640 KB',
    fileType: 'PDF',
    verifiedBadge: 'PhilHealth Portal Synced',
    thumbnail: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?w=200&auto=format&fit=crop&q=80'
  },
  {
    id: 'doc_3',
    ...
    documentNumber: 'NBI-2025-C889104',
    issueDate: '2025-09-02',
    expirationDate: '2026-09-02', // in 18 days
    daysRemaining: 18,
    isEgovRetrieved: true,
    fileSize: '920 KB',
    fileType: 'PDF',
    verifiedBadge: 'NBI Digital Clearance Barcode Verified',
  ...
  },
  {
    ...
    status: 'Valid',
    issuer: 'Barangay Loyola Heights, Quezon City',
    documentNumber: 'BCR-QC-2026-0182',
    issueDate: '2026-02-10',
    expirationDate: '2026-12-31',
    isEgovRetrieved: false,
    fileSize: '1.2 MB',
    fileType: 'JPEG',
    verifiedBadge: 'Barangay Captain E-Seal',
    thumbnail: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=200&auto=format&fit=crop&q=80'
  },
  {
    id: 'doc_5',
    ...
    status: 'Valid',
    issuer: 'Horizon Digital Technologies Inc.',
    documentNumber: 'HR-COE-2026-0044',
    issueDate: '2026-01-20',
    expirationDate: '2027-01-20',
    isEgovRetrieved: false,
    fileSize: '480 KB',
    fileType: 'PDF',
    verifiedBadge: 'HR E-Signature Verified',
    thumbnail: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=200&auto=format&fit=crop&q=80'
  }
];
